...
<body style="background-color : green;">
        <h2 class="text-center pt-4" style="color : red;">Our Customers</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : red;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : pink;">Transfer money</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
         ...
         <footer class="text-center mt-5 py-2">
            <p>&copy 2020 <b>Khansha</b> <br>HSBC Foundation</p>
        </footer>
